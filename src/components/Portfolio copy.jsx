...
export default function Portfolio() {
  return (
    <Section>
      <div className="grid">
        <div className="grid-box double" style={{ background: `url(${portfolio}) no-repeat right center`, backgroundSize: 'cover' }} />
        ...
        <div className="grid-box double" style={{ background: `url(${portfolio7}) no-repeat right center`, backgroundSize: 'cover' }} />
